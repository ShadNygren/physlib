...
/-!
# Per-block count-lattice Lipschitz lemma `facet6G_lip_8` (block 8)

Standalone module for the heavy per-block lattice-Lipschitz lemma of block 8: bumping the
8-th popcount coordinate by `1` (a lattice edge) changes at most one of the 18 output bits of
...
lemma facet6G_lip_8 :
    ∀ n0 ≤ 3, ∀ n1 ≤ 3, ∀ n2 ≤ 1, ∀ n3 ≤ 1, ∀ n4 ≤ 3, ∀ n5 ≤ 1, ∀ n6 ≤ 1, ∀ n7 ≤ 1,
      ∀ n8 ≤ 0, ∀ n9 ≤ 1,
    (∑ j, bdiff (Facet6.facet6G n0 n1 n2 n3 n4 n5 n6 n7 n8 n9 j)
                (Facet6.facet6G n0 n1 n2 n3 n4 n5 n6 n7 (n8+1) n9 j)) ≤ 1 := by
