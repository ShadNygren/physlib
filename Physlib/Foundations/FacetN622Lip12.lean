...
/-!
# Per-block count-lattice Lipschitz lemma `facet22G_lip_12` (block 12)

Bumping the block-12 popcount by `1` (a lattice edge) changes at most one output bit of the
...
lemma facet22G_lip_12 :
    ∀ n0 ≤ 2, ∀ n1 ≤ 1, ∀ n2 ≤ 1, ∀ n3 ≤ 1, ∀ n4 ≤ 1, ∀ n5 ≤ 1, ∀ n6 ≤ 1, ∀ n7 ≤ 1, ∀ n8 ≤ 1, ∀ n9 ≤ 1, ∀ n10 ≤ 1, ∀ n11 ≤ 1, ∀ n12 ≤ 0,
    (∑ j, bdiff (facet22G n0 n1 n2 n3 n4 n5 n6 n7 n8 n9 n10 n11 n12 j)
                (facet22G n0 n1 n2 n3 n4 n5 n6 n7 n8 n9 n10 n11 (n12+1) j)) ≤ 1 := by
