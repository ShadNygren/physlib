...
/-!
# Per-block count-lattice Lipschitz lemma `facet6G_lip_9` (block 9)

Standalone module for the heavy per-block lattice-Lipschitz lemma of block 9: bumping the
9-th popcount coordinate by `1` (a lattice edge) changes at most one of the 18 output bits of
...
lemma facet6G_lip_9 :
    ...
    (∑ j, bdiff (Facet6.facet6G n0 n1 n2 n3 n4 n5 n6 n7 n8 n9 j)
                (Facet6.facet6G n0 n1 n2 n3 n4 n5 n6 n7 n8 (n9+1) j)) ≤ 1 := by
