...
/-!
# Per-block count-lattice Lipschitz lemma `facet1234G_lip_3` (block 3)
...
lemma facet1234G_lip_3 :
    ∀ n0 ≤ 1, ∀ n1 ≤ 3, ∀ n2 ≤ 1, ∀ n3 ≤ 0, ∀ n4 ≤ 1, ∀ n5 ≤ 1, ∀ n6 ≤ 1, ∀ n7 ≤ 1, ∀ n8 ≤ 1, ∀ n9 ≤ 1, ∀ n10 ≤ 1,
    (∑ j, bdiff (facet1234G n0 n1 n2 n3 n4 n5 n6 n7 n8 n9 n10 j)
                (facet1234G n0 n1 n2 (n3+1) n4 n5 n6 n7 n8 n9 n10 j)) ≤ 1 := by
